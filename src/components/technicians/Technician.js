  ...
  return (
    <div className="network__header section__padding">
      <div className="network__header-content">
        ...
        <p>
          In BEN CONNECTIONS Limited, The whole point is not just to provide
          sufficient network and sell our services and products but to build an
          army of people who are all representing that same product or service
